...
enterprise_not_using_visibility_change_disable_policy := false if {
...
enterprise_allows_forking_repos := false if {
...
enterprise_allows_creating_public_repos := false if {
...
enterprise_allows_inviting_externals_collaborators := false if {
...
enterprise_enforce_two_factor_authentication := false if {
